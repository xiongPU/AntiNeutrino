...
// tritium and 3He_1+
  ...
  G4Tritium::TritiumDefinition();
  G4He31p::He31pDefinition();

  G4VDecayChannel *tritiumdecay = new G4PhaseSpaceDecayChannel("Tritium", 1.0, 3, "He31p", "e-", "anti_nu_e");
  G4DecayTable *tritiumdecaytable = new G4DecayTable();
  tritiumdecaytable->Insert(tritiumdecay);
  G4Tritium::Tritium()->SetDecayTable(tritiumdecaytable);
  G4Tritium::Tritium()->DumpTable();
